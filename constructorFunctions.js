 ...
 */
function Course(courseName="Untitled Course", instructor="TBA", creditHours=0, assignments=[]){
...
function Assignment(title="Untitled Assignment", dueDate="TBD"){
    this.title = title;
...
let a6= new Assignment('',"Jan 15",null);
