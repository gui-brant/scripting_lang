let counter = function (increment) {
    ...
    */
    //count = 0 --> This is a global variable declaration!
    let count = 0;
...
/*Closures are functions that "remember" the variables from the place where they were created. 
In practice, you get an inner functions that accesses an outer function's variable, like the counter example above.
In other words, the whole point of this exercise is to make you create a closure called counter and then use it, so you can see how a closure works.*/
